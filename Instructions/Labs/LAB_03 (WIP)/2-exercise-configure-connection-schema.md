...
1. Dentro, crea una nueva instancia de `GraphServiceClient` utilizando como credencial la información sobre el registro de la aplicación Entra que almacenaste previamente:
